-- Rollback for sql/019 — restores match_chunks (sql/015) and keyword_search_chunks (sql/018) WITHOUT
-- the lifecycle='superseded' filter. Apply only to revert 019; superseded docs become retrievable again.
